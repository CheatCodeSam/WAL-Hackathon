build:
    docker build -t fundsui \
        ...
        --build-arg NEXT_PUBLIC_WALRUS_PUBLISHER=https://publisher.walrus-01.tududes.com \
        --build-arg NEXT_PUBLIC_WALRUS_AGGREGATOR=https://aggregator.testnet.walrus.atalma.io \
        .
