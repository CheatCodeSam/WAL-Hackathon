...
export class Channel {
     ...
     * @returns this for method chaining
     */
    setUsername(channelId: string, channelCapId: string, newUsername: string): Channel {
        this.tx.moveCall({
     ...
     * @returns this for method chaining
     */
    setCoverPhoto(channelId: string, channelCapId: string, newCoverPhoto: string): Channel {
        this.tx.moveCall({
     ...
     * @returns this for method chaining
     */
    setProfilePhoto(channelId: string, channelCapId: string, newProfilePhoto: string): Channel {
        this.tx.moveCall({
     ...
     * @returns this for method chaining
     */
    setSubscriptionPrice(channelId: string, channelCapId: string, newPrice: number): Channel {
        this.tx.moveCall({
     ...
     * @returns this for method chaining
     */
    setSubscriptionDuration(channelId: string, channelCapId: string, newDuration: number): Channel {
        this.tx.moveCall({
