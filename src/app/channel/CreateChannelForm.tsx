...
export function CreateChannelForm() {
	...
	const { status, startCreating, finishCreating, failCreating } =
		useChannelPageStore();
						...
						onSuccess: (tx) => {
							suiClient
								...
								.then(async (result) => {
									...
									finishCreating();
									// Redirect to the user's channel page (which will then redirect to their channel)
			...
			>
				...
				<div className="pt-4">
					<button
						...
						type="submit"
					>
						{status === "creating" ? "Creating Channel..." : "Create Channel"}
					</button>
				</div>
			</form>
		</div>
